              ...
              <div className="bg-white rounded-3xl p-6 shadow-card border border-gold-100 overflow-hidden">
                ...
                <div className="relative rounded-2xl overflow-hidden mb-4 border border-gold-100 h-56 bg-gradient-to-br from-purple-100 to-pink-50">
                  ...
                  <iframe
                    ...
                    src={loc.embedUrl || `https://maps.google.com/maps?q=${encodeURIComponent(loc.mapQuery)}&z=16&hl=en&output=embed`}
                  />
                  <a
                    href={loc.mapsLink || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(loc.mapQuery)}`}
                    target="_blank"
                ...
                <div className="flex flex-wrap gap-2">
                  <a
                    href={loc.mapsLink || `https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(loc.mapQuery)}`}
                    target="_blank"
                    rel="noopener noreferrer"
